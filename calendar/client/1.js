!function(t, e) {
	...
	function i(t, e) {
	    return (t = new Date(t)).setFullYear(t.getFullYear() + e),
	    t
	}
	function r(n) {
	    return function(t) {
		return e = "string" == typeof t ? n(t) : t,
	...
	var b = {
		...
		onKeyDown: function(t, e) {
		    ...
		    n === m.esc ? e.close() : a && (t.preventDefault(),
		    e.setState({
		...
		render: function(t) {
			...
			var e = "dp-year";
			return e += t === n ? " dp-current" : "",
			'<button tabindex="-1" type="button" class="' + (e += t === a ? " dp-selected" : "") + '" data-year="' + t + '">' + t + "</button>"
		    }) + "</div>"
		},
		onKeyDown: function(t, e) {
		    var n = t.keyCode
	...
	function d(o, r, a) {
		...
		state: {
		    ...
		    set selectedDate(t) {
			t && !a.inRange(t) || (t ? (i = new Date(t),
			c.state.hilightedDate = i) : i = t,
			c.updateInput(i),
			r("select"),
			c.close())
		    },
		...
		attachToDom: function() {
		    (a.appendTo || document.body).appendChild(c.el)
		},
		...
		close: function(t) {
			...
			var a;
			d = !0,
			t && c.shouldFocusOnBlur && ((a = o).focus(),
			/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream && a.blur()),
			setTimeout(function() {
			    d = !1
			}, 100),
			r("close")
	...
	function c(S, t, e) {
		...
		d = u ? s : i,
		n.classList && (n.classList.toggle("dp-is-above", u),
	...
	function S(t, e, n) {
	    return t = t && t.tagName ? t : document.querySelector(t),
	    "dp-modal" === n.mode ? (o = d(a = t, e, n),
	    a.readonly = !0,
	    o.containerHTML += '<a href="#" class="dp-focuser">.</a>',
	    o) : "dp-below" === n.mode ? c(t, e, n) : "dp-permanent" === n.mode ? ((s = d(r = t, e, i = n)).close = p,
	    s.updateInput = p,
	...
	t.DateRangePicker = function(t, e) {
	    ...
	    c.innerHTML = '<div class="dr-cals"><div class="dr-cal-start"></div><div class="dr-cal-end"></div></div>',
	    c.querySelector(".dr-cals")), r = {
		start: void 0,
		end: void 0
	    ...
	    function p(t) {
		var e, n, a;
		return ((r.end || o) && r.start && (e = t,
		n = r.end || o,
		a = r.start,
		e < a && n <= e || e <= n && a < e) ? "dr-in-range " : "") + (h(t, r.start) || h(t, r.end) ? "dr-selected " : "")
	    }
	    return i.on(u),
	    s.on(u),
	    /iPhone|iPad|iPod/i.test(navigator.userAgent) || a.addEventListener("mouseover", function(t) {
