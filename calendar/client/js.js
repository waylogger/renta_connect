...
function showCalendar() {
    $('#calendar-section').addClass('show');
}

function hideCalendar() {
    $('#calendar-section').removeClass('show');
}

function showPlaceFrom() {
    $('#book__place-options').addClass('show');
}

function hidePlaceFrom() {
    $('#book__place-options').removeClass('show');
}

$("#closeCalendar").bind('click',hideCalendar);
$("#showCalendar").bind('click',showCalendar);
$("#showPlaceFrom").bind('click',hidePlaceFrom);
$("#hidePlaceFrom").bind('click',showPlaceFrom);
